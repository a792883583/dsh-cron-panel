...
const DICTS: Record<Lang, Dict> = {
  zh: {
    ...
    'detail.runNow': '立即运行',
    'detail.retry': '失败自动重试',
    'detail.retry.times': '次',
    'detail.retry.seconds': '秒后重试',
    'detail.retry.hint': '任务失败后自动重试（0 次 = 不重试；间隔为两次尝试之间的等待秒数）',
    'detail.runNow.exit': '退出码',
    'detail.runNow.empty': '（无输出）',
    ...
    'preset.every5Min': '每 5 分钟 (*/5 * * * *)',
    'preset.every15Min': '每 15 分钟 (*/15 * * * *)',
    'preset.every30Min': '每 30 分钟 (*/30 * * * *)',
    'preset.hourly': '每小时整点 (0 * * * *)',
    'preset.workdayMorning': '工作日早 9:00 (0 9 * * 1-5)',
    'preset.daily': '每天午夜 00:00 (0 0 * * *)',
    'preset.weekly': '每周一 00:00 (0 0 * * 1)',
    'preset.monthly': '每月 1 日 00:00 (0 0 1 * *)',
    'msg.saved': '已保存',
    'msg.deleted': '已删除',
    'msg.created': '已创建',
    ...
    'detail.logs.clear': '清空日志',
    'detail.logs.clearConfirm': '确认清空该任务的执行日志？',
  ...
  en: {
    ...
    'detail.retry': 'Retry on failure',
    'detail.retry.times': 'times',
    'detail.retry.seconds': 's delay',
    'detail.retry.hint': 'Retry automatically on failure (0 = no retry; delay is seconds between attempts)',
    'detail.runNow.exit': 'Exit code',
    'detail.runNow.empty': '(no output)',
    ...
    'preset.every5Min': 'Every 5 mins (*/5 * * * *)',
    'preset.every15Min': 'Every 15 mins (*/15 * * * *)',
    'preset.every30Min': 'Every 30 mins (*/30 * * * *)',
    'preset.hourly': 'Hourly (0 * * * *)',
    'preset.workdayMorning': 'Workdays 09:00 AM (0 9 * * 1-5)',
    'preset.daily': 'Daily at 00:00 (0 0 * * *)',
    'preset.weekly': 'Weekly (Mon 00:00) (0 0 * * 1)',
    'preset.monthly': 'Monthly (1st, 00:00) (0 0 1 * *)',
    'msg.saved': 'Saved',
    'msg.deleted': 'Deleted',
    'msg.created': 'Created',
    ...
    'detail.logs.clear': 'Clear logs',
    'detail.logs.clearConfirm': 'Are you sure you want to clear execution logs for this task?',
  ...
  es: {
    ...
    'detail.retry': 'Reintentar al fallar',
    'detail.retry.times': 'veces',
    'detail.retry.seconds': 's de espera',
    'detail.retry.hint': 'Reintenta automáticamente al fallar (0 = sin reintento; espera en segundos entre intentos)',
    'detail.runNow.exit': 'Código de salida',
    'detail.runNow.empty': '(sin salida)',
    ...
    'preset.every5Min': 'Cada 5 minutos (*/5 * * * *)',
    'preset.every15Min': 'Cada 15 minutos (*/15 * * * *)',
    'preset.every30Min': 'Cada 30 minutos (*/30 * * * *)',
    'preset.hourly': 'Cada hora (0 * * * *)',
    'preset.workdayMorning': 'Días laborables 09:00 AM (0 9 * * 1-5)',
    'preset.daily': 'Diario a las 00:00 (0 0 * * *)',
    'preset.weekly': 'Semanal (lun 00:00) (0 0 * * 1)',
    'preset.monthly': 'Mensual (día 1, 00:00) (0 0 1 * *)',
    'msg.saved': 'Guardado',
    ...
    'detail.logs.clear': 'Limpiar registros',
    'detail.logs.clearConfirm': '¿Seguro que desea limpiar los registros de esta tarea?',
